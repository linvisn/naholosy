...
<template>
  <div>
    ...
    <v-overlay v-model="showUpdates" class="d-flex align-center justify-center">
      <v-card class="d-flex flex-column align-start" title="Останнє оновлення" subtitle="16.01.2026" prepend-icon="i-mdi:creation-outline">
        <v-card-text>Було додано переходи для сторінок та деяких елементів.</v-card-text>
      </v-card>
    </v-overlay>
